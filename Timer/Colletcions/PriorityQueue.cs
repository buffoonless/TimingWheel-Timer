...
namespace System.Collections.Generic
{
    ...
    public class PriorityQueue<TElement> where TElement : IComparable<TElement>
    {
        ...
        /// <summary>
        ///  Initializes a new instance of the <see cref="PriorityQueue{TElement}"/> class.
        /// </summary>
        ...
        public PriorityQueue(int initialCapacity)
        {
            if (initialCapacity < 0)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(initialCapacity), initialCapacity, "Non-negative number required");
            }
        ...
        public PriorityQueue(IEnumerable<TElement> items)
        {
            ...
            int _size;
            if (items is ICollection<TElement> ic)
            {
                int count = ic.Count;
                if (count != 0)
                {
            ...
            else
            {
                using (var en = items.GetEnumerator())
                {
                    if (en.MoveNext())
                    {
                        ...
                        _nodes = new TElement[DefaultCapacity];
                        _nodes[0] = en.Current;
                        int count = 1;
                        ...
                        while (en.MoveNext())
                        {
                            if (count == _nodes.Length)
                            {
                                ...
                                // constrain the length to be 0X7FFFFFC7 (this overflow check works because of the
                                // cast to uint).
        ...
        /// <summary>
        ///  Gets the number of elements contained in the <see cref="PriorityQueue{TElement}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Adds the specified element with associated priority to the <see cref="PriorityQueue{TElement}"/>.
        /// </summary>
        /// <param name="element">The element to add to the <see cref="PriorityQueue{TElement}"/>.</param>
        ...
        /// <summary>
        ///  Returns the minimal element from the <see cref="PriorityQueue{TElement}"/> without removing it.
        /// </summary>
        /// <exception cref="InvalidOperationException">The <see cref="PriorityQueue{TElement}"/> is empty.</exception>
        /// <returns>The minimal element of the <see cref="PriorityQueue{TElement}"/>.</returns>
        ...
        /// <summary>
        ///  Removes and returns the minimal element from the <see cref="PriorityQueue{TElement}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Removes the minimal element from the <see cref="PriorityQueue{TElement}"/>,
        ...
        ///  <see langword="false"/> if the <see cref="PriorityQueue{TElement}"/> is empty.
        /// </returns>
        ...
        /// <summary>
        ///  Returns a value that indicates whether there is a minimal element in the <see cref="PriorityQueue{TElement}"/>,
        ///  and if one is present, copies it to the <paramref name="element"/> parameter,
        ///  and its associated priority to the <paramref name="priority"/> parameter.
        ///  The element is not removed from the <see cref="PriorityQueue{TElement}"/>.
        /// </summary>
        ...
        /// <summary>
        ///  Enqueues a sequence of element/priority pairs to the <see cref="PriorityQueue{TElement}"/>.
        /// </summary>
        ...
        public void EnqueueRange(IEnumerable<TElement> items)
        {
            ...
            int count = 0;
            var collection = items as ICollection<TElement>;
        ...
        /// <summary>
        ///  Removes all items from the <see cref="PriorityQueue{TElement}"/>.
        /// </summary>
        public void Clear()
        {
        ...
        /// <summary>
        ///  Ensures that the <see cref="PriorityQueue{TElement}"/> can hold up to
        ...
        /// </exception>
        /// <returns>The current capacity of the <see cref="PriorityQueue{TElement}"/>.</returns>
        ...
        /// <summary>
        ///  Sets the capacity to the actual number of items in the <see cref="PriorityQueue{TElement}"/>,
        ...
        private void Grow(int minCapacity)
        {
            ...
            // Capacities exceeding 0X7FFFFFC7 will be surfaced as OutOfMemoryException by Array.Resize.
        ...
        /// </summary>
        private void MoveUpCustomComparer(TElement node, int nodeIndex)
        {
        ...
        /// </summary>
        private void MoveDownCustomComparer(TElement node, int nodeIndex)
        {
        ...
        /// <summary>
        ///  Enumerates the contents of a <see cref="PriorityQueue{TElement}"/>, without any ordering guarantees.
        /// </summary>
        public sealed class UnorderedItemsCollection : IReadOnlyCollection<TElement>, ICollection
        {
            ...
            /// <summary>
            ///  Enumerates the element and priority pairs of a <see cref="PriorityQueue{TElement}"/>,
